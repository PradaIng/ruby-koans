...
class AboutMethods < Neo::Koan
  ...
  def method_with_var_args_2(a, b, *args)
    args
  end

  def test_calling_with_variable_arguments_2
    assert_equal Array, method_with_var_args_2(1,2).class

    exception = assert_raise(ArgumentError) do
      method_with_var_args_2
    end
    assert_match(/wrong number of arguments \(given 0, expected 2\+\)/, exception.message)

    assert_equal [3, 6, 9], method_with_var_args_2(1, 2, 3, 6, 9)
  end
